...
else
{
   ...
   verifierDonneesEtabM($connexion, $id, $nom, $adresseRue, $codePostal, $ville,  
                        $tel, $nomResponsable, $nombreChambresOffertes,$Informations_pratiques);      
   if (nbErreurs()==0)
   {        
      modifierEtablissement($connexion, $id, $nom, $adresseRue, $codePostal, $ville, 
                            $tel, $adresseElectronique, $type, $civiliteResponsable, 
                            $nomResponsable, $prenomResponsable, $nombreChambresOffertes,$Informations_pratiques);
   }
}
...
<form method='POST' action='modificationEtablissement.php?'>
   ...
   class='tabNonQuadrille'>
      ...
      <tr class='enTeteTabNonQuad'>
         <td align='center' colspan='3'><h4>$nom ($id)</h4></td>
      </tr>
      <tr>
      ...
      <tr class="ligneTabNonQuad">
		 ...
		 <tr class="ligneTabNonQuad">
            ...
            "Informations_pratiques" size ="100" maxlength="255"></td>
         </tr>
   </table>';
   ...
   echo "
      ...
      <tr><br>
         <td align='center'><input type='submit' class='btn4 btn-inverse4' value='Valider' name='valider'>
